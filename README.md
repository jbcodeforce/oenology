# [Oenology](https://jbcodeforce.github.io/oenology)

Read the content of this git from the [book view](https://jbcodeforce.github.io/oenology)
...
2. `git clone https://github.com/jbcodeforce/aenology.git` _(or your forked repository if you plan to edit)_
3. `cd aenology`
4. `mkdocs serve`
